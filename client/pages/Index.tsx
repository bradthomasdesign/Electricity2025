  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-base font-normal text-gray-500 tracking-widest uppercase mb-12">
              EVENTS & TRAININGS
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20">
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-epri-slate">
                Events Calendar
              </h3>
              ...
              <button className="bg-epri-slate text-white px-6 py-2.5 text-sm hover:bg-epri-dark-blue transition-colors">
