    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="flex items-center gap-4 text-white">
          ...
          <button
            onClick={toggleLogin}
            className="hidden md:block text-base hover:text-epri-light-blue transition-colors cursor-pointer"
          >
            {isLoggedIn ? "Log Out" : "Log In or Register"}
          </button>
        </div>
      ...
      {/* Statistics Section */}
      <section className="relative py-10 sm:py-16 lg:py-20 bg-transparent -mt-60 sm:mt-1 lg:-mt-24">
      ...
      <footer className="bg-white py-6 border-t">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            {/* Logo */}
            <div className="text-epri-lighter-blue">
